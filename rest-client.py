...
def main():
    ...
    try:
        ...
        load_dotenv()
        ai_endpoint = os.getenv('D3oNqMI8tlJyoxJJ18LKsHbuduMqJCvGln1s2go3SZMk5ZrVk6VOJQQJ99BCACYeBjFXJ3w3AAAEACOGnKyg')
        ai_key = os.getenv('https://azure-ai-service01.cognitiveservices.azure.com/')
